...
function flista_niveles_x_zona($nivel_sinpermiso="",$liga1="",$liga2="",$liga3="",$liga4=""){    
    $totcol1=0; $colinks="";
    // if ($nivel_sinpermiso!=""){ // arreglo de niveles sin permiso
    //     $arrnopermiso=explode("|",$nivel_sinpermiso);
    //     $cad1=""; $cad2=""; foreach ($arrnopermiso as $valor) {if ($valor<10){ $cad1=$cad1.$valor.","; }else{ $cad2=$cad2.$valor."|"; } } 
...
function flista_ZONAS_x_almacen_nivel($pmidnivel,$condicion_particular="",$liga1="",$liga2="",$liga3="",$liga4=""){ // pendiente
    // Solo usada por ALMACEN 
    if ($condicion_particular!=""){ $condicion_particular="and ".$condicion_particular; }
    $totcol1=0; $colinks="";
    $_sql="select distinct a.cct_zona,a.zonaescola,b.nombre,b.fer_idniveles,count(a.cct) as escuelas,a.nivel from ctsev a,supervis_c b where a.cct_zona=b.cuenta and (a.idalmarec=".$_SESSION["vg_idalmacen"]." || a.idalmadis=".$_SESSION["vg_idalmacen"].") and a.idnivel='".$pmidnivel."' ".$condicion_particular." and a.estatus='A' group by a.cct_zona order by a.cct_zona";
    echo "<br><br><br>";

...
function flista_niveles_x_almacen($pmalmacen,$nivel_sinpermiso="",$liga1="",$liga2="",$liga3=""){    
    ...
    $_sql="select distinct id".$pmalmacen.",".$pmalmacen.",idnivel,nivel,SUM(if(cct_sector!='',1,0)) AS ban,COUNT(distinct cct_sector) AS sectores,COUNT(distinct cct_zona) AS zonas FROM ctsev_indigena WHERE id".$pmalmacen."='".$_SESSION["vg_idalmacen"]."'".$condpermiso." and estatus='A' GROUP BY id".$pmalmacen.",idnivel";                            
...
function flista_niveles_x_sector($nivel_sinpermiso="",$liga1="",$liga2="",$liga3=""){    
    ...
    $_sql="select distinct idnivel,nivel,COUNT(distinct cct_zona) AS zonas,COUNT(distinct concat(cct,turno)) AS escuelas FROM ctsev_indigena WHERE  idnivel<70 and cct_sector='".$_SESSION["vg_cct_sector"]."'".$condpermiso." and estatus='A' GROUP BY idnivel";                            
...
function flista_SECTORES_x_almacen_nivel($pmidnivel,$nivel_sinpermiso="",$condicion_particular="",$liga1="",$liga2="",$liga3=""){ 
    ...
    $_sql="select distinct a.cct_sector,a.sector,b.nombre,a.idnivel,a.nivel,COUNT(distinct a.cct_zona) as zonas,b.fer_idniveles,b.folio from ctsev_indigena a,sector_c b where a.cct_sector=b.cuenta and a.idnivel='".$pmidnivel."' ".$condicion_particular." and a.cct_sector!='' and a.estatus='A' group by a.cct_sector order by a.cct_sector";
    echo "<br><br><br><br>";  
   // echo "flista_SECTORES_x_almacen_nivel<br><br><br><br>".$_sql."<br>";
...
function flista_ZONAS_x_almacen_nivel($pmidnivel,$condicion_particular="",$liga1="",$liga2="",$liga3="",$liga4="",$liga5=""){ // pendiente
    ...
    if ($condicion_particular!=""){ $condicion_particular="and ".$condicion_particular; }
    $totcol1=0; $colinks="";
    $_sql="select distinct a.cct_zona,a.zonaescola,b.nombre,b.fer_idniveles,count(a.cct) as escuelas,a.nivel from ctsev_indigena a,supervis_c b where a.cct_zona=b.cuenta and a.idnivel='".$pmidnivel."' ".$condicion_particular." and a.estatus='A' group by a.cct_zona order by a.cct_zona";
    echo "<br><br><br><br>";
    // echo "<br><br>flista_ZONAS_x_almacen_nivel<br><br>".$_sql;
...
function flista_Escuelas_x_zona_nivel($pmcct_zona,$pmidnivel,$condicion_particular="",$liga1="",$liga2="",$liga3=""){ // pendiente
    ...
    if ($condicion_particular!=""){ $condicion_particular="and ".$condicion_particular; }
    $totescuelas=0;
    $_sql="select distinct cct,turno,nom_ct,nivel from ctsev_indigena where cct_zona='".$pmcct_zona."' and idnivel='".$pmidnivel."' ".$condicion_particular." and estatus='A' order by cct,turno";

...
if ((!isset($logeado) && !isset($TxtUsuario))){
    ...
    if (!isset($_GET["arr_nivel"])){ 	
        // ------------------------------------------------------------------- BANNER ENCABEZADO --------------------------------------------------------------- 
        $TItulo="<h3 class='fbold ftext-red'>Sector ".$logeado."</h3>"; $subtit="Seleccione nivel"; 		 
        ...
        if ($_GET["sel"]=="Sectores"){
            ...
            // LISTA DE ZONAS
            flista_ZONAS_x_almacen_nivel($elidnivel,"","Recibo|../ingresosupervisor/recibo_pauta_libros_zona.php?||#F9FFE4");
        }
    }
}
?>

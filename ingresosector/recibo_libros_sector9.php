...
//------------------------------------------------------------------------------------------------------------------------------------------
                ...
                <section><? //    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    LIBROS PARA ESCUELA (MAESTROS) Y LIBROS PARA ALUMNOS Y ESCUELA    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                    if ($elidnivel<40){   //   ----------------    PREESCOLAR
                        ...
                        Se entrega material de las claves K1LDG, K2LDG y K3LDG a las esuelas que tengan matrícula asignada en los grados 1°, 2° y 3°. </small><br><br><br>  
                        <?
                    } 
                    if ($elidnivel<40){    //   ----------------    PREESCOLAR
                        ...
                        <div><small>De la clave K0CFA se entregan 2 ejemplares por plantel escolar.<br></small><br><br>
                        <?

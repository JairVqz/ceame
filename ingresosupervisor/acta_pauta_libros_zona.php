...
if ((!isset($logeado) && !isset($TxtUsuario))){	fmessage("Acceso No Permitido",1500,2,$vl_back);
        ...
        if ($_SESSION["vg_tipousuario"]=="Supervisor"){
            $elidnivel=$rec_zona_alumno["idnivel"];
        ...
        $_sql="select * from almacen_c where idalmacen=".$rec_zona_alumno[$campoalmacen]; //	echo $_sql; 
		...
		<div style='margin-left:50px; margin-right:50px;  text-align: justify; font-size:14px'>
            ...
            PERTENECEN A LA SUPERVISIÓN ESCOLAR, CONFORME AL RECIBO CON FOLIO <span style='font-weight:bold'>LTG <? echo $rec_zona_alumno["folio"]; ?></span>.
            <br><br>
            2.- LA ENTREGA SE EFECTUA CONSIDERANDO LA ASIGNACIÓN POR GRADO: <br>
                <table width="400" style="margin:10px; font-size:14px">
                    <tr><td width="100"></td><td><li> PRIMER GRADO</li></td><td style="text-align:right"><span style='font-weight:bold'><? echo number_format($rec_zona_alumno["alu1"],0); ?></span></td><td>&emsp;LIBROS</td></tr>
                    <tr><td width="100"></td><td><li> SEGUNDO GRADO</td><td style="text-align:right"><span style='font-weight:bold'><? echo number_format($rec_zona_alumno["alu2"],0); ?></span></td><td>&emsp;LIBROS</td></tr>
                    <tr><td width="100"></td><td><li> TERCER GRADO</td><td style="text-align:right"><span style='font-weight:bold'><? echo number_format($rec_zona_alumno["alu3"],0); ?></span></td><td>&emsp;LIBROS</td></tr>
                </table>

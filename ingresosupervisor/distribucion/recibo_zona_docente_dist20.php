...
<body <? if (!isset($_GET["x"]) && ($_SESSION["vg_tipousuario"]=="Almacen")){ ?> class="fcenter" <?}else{ ?> style="margin-left:auto; margin-right:auto; max-width:1200px; text-align:center; font-size:14px;" <? } ?>>  <?
    ...
    if ((!isset($logeado) && !isset($TxtUsuario))){
        ...
        if ($_SESSION["vg_tipousuario"]=="Almacen" && !isset($_GET["x"])){
            ...
            $_sql="select distinct a.sector,a.zonaescola,a.cct_zona,b.nombre from ctver_distribucion20 a, supervis_c b where a.cct_zona=b.cuenta and a.estatus='A' and a.idalmadis=".$_SESSION["vg_idalmacen"]." and a.idnivel=".$_GET["n"]; 	//echo "<br><br><br><br>".$_sql; 
                        ...
                        <tr><th>Sector</th><th>Zona</th><th>Cct-zona</th><th>Nombre</th><th></th></tr><? 
                            while ($r<mysql_num_rows($res)){ 		$recset=mysql_fetch_array($res,MYSQL_ASSOC); $tot=0; 
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <small><a class="fbutton fpadding-tiny fround fbold fpale-green" href="<? echo $autollamada."x&n=".$_GET["n"]."&".$nomarreglo."=".oculta($caddatos,0); ?>">Recibo de Biblioteca SEP: Paulo Freire</a></small>    
                                    </td> 
                                </tr> <? 
                                $r++; 
                            } ?>		 
            ...
            if ($_SESSION["vg_tipousuario"]=="Supervisor" && !isset($_GET["seleccionado"])){
                ...
                // -----------------------------------------------------------------------------------------------------------------------------------------------------
                $liga1="Recibo de Biblioteca SEP: Paulo Freire|".$autollamada."seleccionado&||#F9FFE4|";	//Boton|liga|Columna|color|idnivel|nivelesrestringidos
            ...
            if ($vl_procede==1){ 
                ...
                <div style='margin-left:50px; margin-right:50px;  font-weight:bold'>
                            ...
                            <span style="font-weight:bold; font-size:16px">RECIBO DE ZONA:  "Biblioteca SEP Centenaria 2024: Paulo Freire" <br>
                ...
                //---------------------------------------------------------------------------------------------------------------------------------------------- ?>
                            ...
                            <h4 style="text-align:center">Contenido de la Biblioteca SEP Centenaria 2024: Paulo Freire</h4>  
                            <table width="500" cellpadding=5 cellspacing=0 align="center"> <!-- Tabla descriptiva, sin cantidades variables por eso no se usa programa para llenarla -->
                                <tr><td style="font-size:14px; font-weight:bold">Clave</td><td style="font-size:14px; font-weight:bold;">Titulo</td><tr>
                                <tr><td>1</td><td style="text-align:left">&emsp;Cartas a Cristina</td><tr>
                                <tr><td>2</td><td style="text-align:left">&emsp;Cartas a quien pretende enseñar</td><tr>
                                <tr><td>3</td><td style="text-align:left">&emsp;El grito manso</td><tr>
                                <tr><td>4</td><td style="text-align:left">&emsp;El maestro sin recetas</td><tr>
                                <tr><td>5</td><td style="text-align:left">&emsp;La educación como práctica de la libertad</td><tr>
                                <tr><td>6</td><td style="text-align:left">&emsp;La educación en la ciudad</td><tr>
                                <tr><td>7</td><td style="text-align:left">&emsp;La importancia de leer y el proceso de liberación</td><tr>
                                <tr><td>8</td><td style="text-align:left">&emsp;Pedagogía de la autonomía</td><tr> 
                                <tr><td>9</td><td style="text-align:left">&emsp;Pedagogía de la esperanza</td><tr>
                                <tr><td>10</td><td style="text-align:left">&emsp;Pedagogía de la indignación</td><tr>
                                <tr><td>11</td><td style="text-align:left">&emsp;Pedagogía de los sueños posibles</td><tr>
                                <tr><td>12</td><td style="text-align:left">&emsp;Pedagogía del oprimido</td><tr>
                                <tr><td>13</td><td style="text-align:left">&emsp;Política y educación</td><tr>
                                <tr><td>14</td><td style="text-align:left">&emsp;Por una pedagogía de la pregunta</td><tr>
                                <tr><td>15</td><td style="text-align:left">&emsp;Miedo y osadía</td><tr>
                                <tr><td>16</td><td style="text-align:left">&emsp;La voz del maestro</td><tr>
                                <tr><td>17</td><td style="text-align:left">&emsp;Pedagogía de la tolerancia</td><tr>
                                <tr><td>18</td><td style="text-align:left">&emsp;¿Extensión o comunicación?</td><tr>                            </table>
                            <br><br><p class="SaltoDePagina" style="text-align:left"><small><? echo $liga; ?></small></p>
                            <?
                //----------------------------------------------------------------------------------------------------------------------------------------------  ?>
                            <br><br><br>
                            <?  $_sql="select a.* from ctver_distribucion20 a where a.estatus='A' ".$condidalmacen." and a.cct_zona='".$vg_cct_zona."' and a.idnivel=".$vl_idnivel; 	//echo $_sql; 
                            ...
                            <?
                                    ...
                                    while ($r<=mysql_num_rows($res_esc)){
                                        ...
                                        $r++;   $x++;
                                            ...
                                            <tr>
                                                <td colspan=5 style="text-align:right; height:40px"><small>Total a recibir (escuelas)</small></td>
                            ...
                            <table cellpadding="7" cellspacing="0" width="100%" border=1><tr><td>NOTA: Se entrega una Biblioteca con 18 títulos por plantel escolar</td></tr></table>
                            <br><br>

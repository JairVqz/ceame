        ...
        case 2:  //  Ingresa Almacen (de la liga en ex=1) e ingresa Supervisor (de su menu principal)
            ...
            if ($vl_procede==1){ 
                ...
                <div style='margin-left:50px; margin-right:50px;  font-weight:bold'>
                            ...
                            <span style="font-weight:bold; font-size:16px">RECIBO DE ZONA:  "Plan de estudios para la educación preescolar, primaria y sevcundaria" <br>
                ...
                //---------------------------------------------------------------------------------------------------------------------------------------------- ?>
                            ...
                            <h4 style="text-align:center">Contenido del Plan de esudios</h4>  
                            <table width="700" cellpadding=5 cellspacing=0 align="center"> <!-- Tabla descriptiva, sin cantidades variables por eso no se usa programa para llenarla -->
                                ...
                                <tr><td>Z7844</td><td style="text-align:left">&emsp;lan de Estudio para la Educación Preescolar, Primaria y Secundaria.</td><tr>

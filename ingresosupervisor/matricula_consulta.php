...
if (isset($_GET["devolucion"])){ $_SESSION["dev"]=$_GET["devolucion"]; }
?>
		...
		<div class="row">
			<div class="col-md-12">
				...
				if ((!isset($logeado) && !isset($TxtUsuario))){
					...
					//------------------------------------------------------------------------------
					switch ($vg_tipousuario){ // solo para determinar el vl_back
						case "Supervisor":	$vl_back="../_panel.php";	break;
						case "NivelPreesEstatal":
						case "NivelPreesFederal":
						case "NivelPrimariaEstatal":
						case "NivelPrimFederal":							
						case "NivelPrimPreesIndigen":	
						case "NivelSecundEstatal";
						case "NivelSecundGral";
						case "NivelSecundTecnica";	
							if ($_GET["ejecucion"]==1){
								$vl_back=$autollamada."ejecucion=2&basenivel=".$_GET["basenivel"]."&almacen_seleccionado=".$_GET["almacen_seleccionado"]."&bodega=".$_GET["bodega"];
							}else{
								if (isset($_GET["almacen_seleccionado"])){
									$vl_back=$autollamada."ejecucion=2&basenivel=".$_GET["basenivel"];
								}else{	
									$vl_back="../_panel.php"; 
								}
							}							
						...
						case "Sector":	
							...
							break;
						case "Almacen":
							if ($_GET["ejecucion"]==1){$vl_back=$autollamada."ejecucion=2&basenivel=".$_GET["pmbasenivel"]; }else{if (isset($_SESSION["dev"])){ $vl_back="../_panel.php?papa=1556";}else{$vl_back="../_panel.php?papa=9"; } }
							break;
						default:
							if ($_GET["ejecucion"]==1){$vl_back=$autollamada."ejecucion=2&basenivel=".$_GET["pmbasenivel"]."&almacen_seleccionado=".$_GET["almacen_seleccionado"]."&bodega=".$_GET["bodega"]; }else{ if (isset($_GET["almacen_seleccionado"])){$vl_back=$autollamada."ejecucion=2&basenivel=".$_GET["basenivel"]; }else{     if (isset($_SESSION["dev"])){ $vl_back="../_panel.php?papa=1556";}else{$vl_back="../_panel.php?papa=9"; }      }}
							break;
					}		
					if ($ejecucion==2){ 
					...
					<div style="text-align:center; margin-left:50px; margin-right:50px"><?
						...
						switch ($ejecucion){
							case 1:   // 	  Consulta y balance general de la zona (muestra escuelas pendientes y escuelas con matricula)
								switch ($vg_tipousuario){
									...
									case "Sector":
										...
										$vl_tit="-";
										switch($arrnivel[0]){
											case 30: case 31: case 32: case 34: case 36:  $basenivel=3;		$vl_tit="PREESCOLAR"; break;
											case 40: case 41: case 42: case 44:	case 46: $basenivel=4;     	$vl_tit="PRIMARIA"; break;
											case 60: case 61: case 65:  $basenivel=6;  $cat_escuelas="ctsev";	$vl_tit="SECUNDARIA";  break;
											case 72: case 73: case 74: case 76:  $basenivel=7;  $cat_almacenes="almacen_c";  $vl_tit="TELESECUNDARIA"; break; 
										}
										$vl_cerrarventana="NO";
										break;
									default:
										...
										switch($basenivel){
											case 3:	
												switch($_SESSION["vg_tipousuario"]){
													...
													case "NivelPreesFederal": $vl_losniveles="31"; $vl_tit="PREESCOLAR FEDERAL"; break;
													case "NivelPrimPreesIndigen": $vl_losniveles="32"; $vl_tit="PREESCOLAR INDÍGENA"; break;
											...
											case 4:	
												switch($_SESSION["vg_tipousuario"]){
													...
													case "NivelPrimPreesIndigen": $vl_losniveles="42"; $vl_tit="PRIMARIA INDÍGENA"; break;
													case "NivelPrimFederal": $vl_losniveles="41"; $vl_tit="PRIMARIA FEDERAL";	break;
													default: $vl_losniveles="40,41,42,45,46";	break;
												}	
												$vl_tit="PRIMARIA";
												break;
											case 6:	
												...
												switch($_SESSION["vg_tipousuario"]){
													...
													case "NivelSecundGral": $vl_losniveles="61"; $vl_tit="SECUNDARIA GENERAL";	break;
													case "NivelSecundTecnica": $vl_losniveles="65"; $vl_tit="SECUNDARIA TÉCNICA";	break;
													default: $vl_losniveles="60,61,65";	break;
												}										
												$vl_tit="SECUNDARIA";		
												break;
											case 7:	
												switch($_SESSION["vg_tipousuario"]){
													case "NivelTelesecEstatal": $vl_losniveles="72"; $vl_tit="TELESECUNDARIA ESTATAL";	break;
													case "NivelTelesecFederal": $vl_losniveles="73"; $vl_tit="TELESECUNDARIA FEDERAL";	break;
													default: $vl_losniveles="72,73,74,76";  break;
												}											
												$vl_tit="TELESECUNDARIA";	
												break; 
										}
                                ...
                                switch($_SESSION["vg_tipousuario"]){
                                    case "Almacen": $condalmacenes1=" and a.idalmarbo=".$_SESSION["vg_idalmacen"]; break;
                                    case "Supervisor":$condalmacenes1=""; break;
                                    default: $condalmacenes1="and a.idalmarbo=".$_GET["almacen_seleccionado"]; break;
                                }
								//$laconsulta="select a.nom_ct,a.cct as Escuela,a.turno,a.idnivel,".$vl_muestra_asig." from $cat_escuelas a where a.idalmarbo=$idalmadis and a.cct_sector='$cvesector' and a.cct_zona='$cvezona' and a.estatus='A' and a.idnivel in ($vl_losniveles) and day(a.fecha_matricula)=0 group by a.cct_zona,a.cct,a.turno order by a.idalmarbo,a.cct";
								$laconsulta="select a.nom_ct,a.cct as Escuela,a.turno,a.idnivel,".$vl_muestra_asig." from $cat_escuelas a where a.cct_sector='$cvesector' and a.cct_zona='$cvezona' and a.estatus='A' and a.idnivel in ($vl_losniveles) and day(a.fecha_matricula)=0 ".$condalmacenes1." group by a.cct_zona,a.cct,a.turno order by a.idalmarbo,a.cct";
								//	echo $laconsulta;
								...
								/*******************************************************************  */
								//$_sql_asig="select a.zonaescola,a.sector,a.idalmarbo,a.cct as Escuela,a.turno,".$vl_muestra_asig.",a.nom_ct,a.idnivel from $cat_escuelas a where a.idalmarbo=$idalmadis and a.cct_sector='$cveector' and a.cct_zona='$cvezona' and a.estatus='A' and a.idnivel in ($vl_losniveles) and day(a.fecha_matricula)>0 group by a.cct_zona,a.cct,a.turno order by a.cct";
								$_sql_asig="select a.zonaescola,a.sector,a.idalmarbo,a.cct as Escuela,a.turno,".$vl_muestra_asig.",a.nom_ct,a.idnivel from $cat_escuelas a where a.cct_sector='$cvesector' and a.cct_zona='$cvezona' and a.estatus='A' and a.idnivel in ($vl_losniveles) and day(a.fecha_matricula)>0 ".$condalmacenes1." group by a.cct_zona,a.cct,a.turno order by a.cct";
								//$_sql_capt="select a.idalmarbo,a.cct as Escuela,a.turno,".$vl_muestra_capt." from $cat_escuelas a where a.idalmarbo=$idalmadis and a.cct_sector='$cvesector' and a.cct_zona='$cvezona' and a.estatus='A' and a.idnivel in ($vl_losniveles) and day(a.fecha_matricula)>0 group by a.cct_zona,a.cct,a.turno order by a.cct";
								$_sql_capt="select a.idalmarbo,a.cct as Escuela,a.turno,".$vl_muestra_capt." from $cat_escuelas a where a.cct_sector='$cvesector' and a.cct_zona='$cvezona' and a.estatus='A' and a.idnivel in ($vl_losniveles) and day(a.fecha_matricula)>0 ".$condalmacenes1." group by a.cct_zona,a.cct,a.turno order by a.cct";
								...
								<? }
								if ($generadodesde==3){	
									echo "<span class='negra_22'><a href='$vl_back'>Regresar</a></span><br><br><br>";
								}else{ ?>
									<p class='SaltoDePagina'></p><br><br><br><br><br><br><hr><br><br><br><br><br><br><?
									echo "<div>".PieRecibo($cvezona,"qr_matricula_".$elnivel."/")."</div>";
								}
								break;	
							case 2:   //      SE CONSULTA EL ctsev de acuerdo a $vl_losniveles (visto por jefes,almacenes y responsables de nivel )
								//Avance POR ALMACEN de la captura de matricula se ven las zonas no concluidas se genera desde la ejecucion 102 solo para jefes
								$latabla="ctsev";
								$basenivel=$_GET["basenivel"];
								switch($basenivel){
									case 3:	
                                        $order="sector,zonaescola";
										switch($_SESSION["vg_tipousuario"]){
											case "NivelPreesEstatal": $vl_losniveles="30"; break;
											case "NivelPreesFederal": $vl_losniveles="31"; break;
											case "NivelPrimPreesIndigen": $vl_losniveles="32"; break;
											default: $vl_losniveles="30,31,32,34,35,36"; break;
										}	
										$vl_tit="PREESCOLAR";
										break;
									case 4:	
                                        $order="sector,zonaescola";
										switch($_SESSION["vg_tipousuario"]){
											case "NivelPrimariaEstatal": $vl_losniveles="40"; break;
											case "NivelPrimPreesIndigen": $vl_losniveles="42"; break;
											case "NivelPrimFederal": $vl_losniveles="41"; break;
											default: $vl_losniveles="40,41,42,45,46"; break;
										}	
										$vl_tit="PRIMARIA";
										break;
									case 6:	
                                        $order="sector,idnivel";
										$latabla="ctsev";
										switch($_SESSION["vg_tipousuario"]){
											case "NivelSecundEstatal": $vl_losniveles="60"; break;
											case "NivelSecundGral": $vl_losniveles="61"; break;
											case "NivelSecundTecnica": $vl_losniveles="65"; break;
											default: $vl_losniveles="60,61,65"; break;
										}	
										$vl_tit="SECUNDARIA";											
										break;
									case 7:	
                                        $order="sector,zonaescola";
										switch($_SESSION["vg_tipousuario"]){
											case "NivelTelesecEstatal": $vl_losniveles="72,74"; break;
											case "NivelTelesecFederal": $vl_losniveles="73,76"; break;
											default: $vl_losniveles="72,73,74,76";  break;
										}												
										$vl_tit="TELESECUNDARIA";
										break; 
                                ...
                                if (!isset($_GET["almacen_seleccionado"]) && $_SESSION["vg_tipousuario"]!="Almacen"){ // NO HAY ALMACEN SELECCIONADO y muestra la lista de almacenes
                                    $_sql="select idalmarbo,almadis,count(cct) as Escuelas,nivel,SUM(if(day(fecha_matricula)>0,1,0)) as registradas,SUM(if(day(fecha_matricula)=0,1,0)) as porregistrar FROM ctsev where idnivel in (".$vl_losniveles.") and estatus='A' group by idalmarbo order by idalmarbo*1";
                                    // echo "NO HAY ALMACEN SELECCIONADO----".$_sql;
                                                ...
                                                <tr><td style="background:#F8F8F8; height:30px;"><b>Num</b></td><td style="background:#F8F8F8;"><b>Almacen</b></td><td style="background:#F8F8F8;"><b>Escuelas</b></td><td style="background:#F8F8F8;"><b>Registradas</b></td><td style="background:#F8F8F8;"><b>Por registrar</b></td><td style="background:#F8F8F8; text-algn:center"><b>Captura de matrícula</b></td><td style="background:#F8F8F8;"></td></tr><? 
                                                    while ($r<mysql_num_rows($res)){ 		$recset=mysql_fetch_array($res,MYSQL_ASSOC); $tot=0; 
                                                        ...
                                                        <tr> 
                                                            ...
                                                            <td><a href="<? echo $autollamada."ejecucion=2&basenivel=".$basenivel."&almacen_seleccionado=".$recset["idalmarbo"]."&bodega=".$recset["almadis"]; ?> " class="fbutton fround fpale-yellow fbold fpadding-small"><small>Ver detalle</small></a></td>
                                                        </tr> <? 
								...
								}else{ //-------------------   CUANDO YA SE SELECCIONO ALMACEN
                                    if ($_SESSION["vg_tipousuario"]=="Almacen"){$almacenseleccionado=$_SESSION["vg_idalmacen"];}else{$almacenseleccionado=$_GET["almacen_seleccionado"];}
                                    if ($almacenseleccionado==2){
                                        $condalmacenes2="and (idalmarbo=".$almacenseleccionado." || idalmadis=".$almacenseleccionado.")";
                                    }else{
                                        $condalmacenes2="and idalmarbo=".$almacenseleccionado;
                                    }
                                    $_sql="select (sector*1) as sector,(zonaescola*1) as zonaescola,cct_sector,cct_zona,idnivel,nivel,count(cct) as Escuelas,SUM(if(day(fecha_matricula)>0,1,0)) as registradas,SUM(if(day(fecha_matricula)=0,1,0)) as porregistrar FROM ".$latabla." where estatus='A' and idnivel in (".$vl_losniveles.") ".$condalmacenes2."  group by cct_sector,cct_zona order by ".$order;
                                        //echo "YA HAY ALMACEN SELEECIONADO----".$_sql;
                                    $res=mysql_query($_sql); 		$r=0; 
                                    if (mysql_num_rows($res)>0){ 
                                            if (isset($_GET["bodega"])){ echo "<h3 class='fbold'>Almacen ".$_GET["bodega"]."</h3>"; }else{ echo "<h3 class='fbold'>Almacen ".$logeado."</h3>"; }
                                            if ($basenivel==6){
                                                echo "<h4>Consulta de balance de matrícula de escuelas de ".mysql_num_rows($res)." Zonas de $vl_tit</h4><br>";  ?> 
                                                <table id="tabla_imprime" width="1200" border=1 align="center" style="border-color:#CCCCCC" cellpadding=50 cellspacing=0> 
    
                                                    <col class="col1"/><col class="col2"/><col class="col3"/><col class="col4"/><col class="col5"/><col class="col6"/><col class="col7"/><col class="col8"/>
                                                    <tr><td colspan="3" class="fblack"></td><td colspan="6" class="fdark-gray fbold"><h3>Matrícula</h3></td><? if (isset($_SESSION["dev"])){ ?><td class="fblack fbold ftext-white"><h3>Devolución</h3></td><? } ?></tr>
    
                                                    <tr><td style="background:#F8F8F8; height:30px;"><b>Sector</b></td><td style="background:#F8F8F8;"><b>Zona</b></td><td style="background:#F8F8F8;"><b>Nivel</b></td><td style="background:#F8F8F8;"><b>Cct_zona</b></td><td style="background:#F8F8F8;"><b>Escuelas</b></td><td style="background:#F8F8F8;"><b>Registradas</b></td><td style="background:#F8F8F8;"><b>Por registrar</b></td><td style="background:#F8F8F8; text-align:center"><b>Captura de matricula</b></td><td style="background:#F8F8F8;"></td></tr><? 
                                                        while ($r<mysql_num_rows($res)){ 		$recset=mysql_fetch_array($res,MYSQL_ASSOC); $tot=0; 
                                                            ...
                                                            <tr> 
                                                                ...
                                                                <td style="text-align:center"><? echo $recset["Escuelas"]; ?></td> 
                                                                <td style="text-align:center"><? echo $recset["registradas"]; ?></td> 
                                                                <td style="text-align:center"><? echo $recset["porregistrar"]; ?></td> 
																<td><? if ($recset["porregistrar"]==0){ echo "<span style='color:green; font-weight:bold'>Concluida</span>"; }else{ echo "<small style='color:red'>Pendiente</small>"; } ?></td> 
                                                                <? 
                                                                $enlace="../ingresosupervisor/recibo_matricula_zona.php?sel=escuela&idnivel=".$recset["idnivel"]."&nivel=".$recset["nivel"]."&cct_zona=".$recset["cct_zona"]."&almacen_seleccionado=".$_SESSION["vg_idalmacen"];
                                                                if (isset($_GET["bodega"])){ $enlace=$enlace."&almacen_seleccionado=".$almacenseleccionado."&bodega=".$_GET["bodega"]; } ?>
                                                                
                                                                <td><a href="<? echo $enlace; ?>" class="fbutton fround fpale-yellow fbold fpadding-small"><small>Ver escuelas</small></a></td>
																<? if (isset($_SESSION["dev"])){ ?>
																	<td><a href="../ingresoalmacen/inventario_dev.php?ex=1&n=<? echo $_GET["basenivel"]; ?>" class="fbutton fround fpale-green fbold fpadding-small"><small>Registro devolución</small></a></td>
																<? } ?>
                                                            </tr> <? 
                                                            $tot1=$tot1+$recset["Escuelas"];	$tot2=$tot2+$recset["registradas"];	$tot3=$tot3+$recset["porregistrar"];	$r++; 
                                                        } ?>		 
                                                    <tr class="fdark-gray"><td colspan='4'>Total</td><td  style="text-align:center"><? echo $tot1; ?></td><td  style="text-align:center"><? echo $tot2; ?></td><td  style="text-align:center"><? echo $tot3; ?></td><td colspan="2" class='fright-align'></td></tr> 
                                                </table><? 
                                            }else{    
                                                ...
                                                <table id="tabla_imprime" width="1200" border=1 align="center" style="border-color:#CCCCCC" cellpadding=50 cellspacing=0> 
                                                    ...
                                                    <col class="col1"/><col class="col2"/><col class="col3"/><col class="col4"/><col class="col5"/><col class="col6"/><col class="col7"/><col class="col8"/>
                                                    <tr><td colspan="2" class="fblack"></td><td colspan="6" class="fdark-gray fbold"><h3>Matrícula</h3></td><? if (isset($_SESSION["dev"])){ ?><td class="fblack fbold ftext-white"><h3>Devolución</h3></td><? } ?></tr>
    
                                                    <tr><td style="background:#F8F8F8; height:30px;"><b>Sector</b></td><td style="background:#F8F8F8;"><b>Zona</b></td><td style="background:#F8F8F8;"><b>Cct_zona</b></td><td style="background:#F8F8F8;"><b>Escuelas</b></td><td style="background:#F8F8F8;"><b>Registradas</b></td><td style="background:#F8F8F8;"><b>Por registrar</b></td><td style="background:#F8F8F8; text-align:center"><b>Captura de matrícula</b></td><td style="background:#F8F8F8;"></td><? if (isset($_SESSION["dev"])){ ?><td style="background:#F8F8F8;"></td><? } ?></tr><? 
                                                        while ($r<mysql_num_rows($res)){ 		$recset=mysql_fetch_array($res,MYSQL_ASSOC); $tot=0; 
                                                            $nomarreglo=""; $caddatos=$recset["sector"]."|".$recset["zona"]; 	?> 
                                                            <tr> 
                                                                <td><? echo $recset["sector"]; ?></td> 
                                                                ...
                                                                <td><a href="<? echo $enlace; ?>" class="fbutton fround fpale-yellow fbold fpadding-small"><small>Balance de zona</small></a></td>
																<? if (isset($_SESSION["dev"])){ ?>
																	<td><a href="../ingresoalmacen/inventario_dev.php?ex=1&n=<? echo $_GET["basenivel"]; ?>&pm_zona=<? echo $recset["cct_zona"]; ?>" class="fbutton fround fpale-green fbold fpadding-small"><small>Registro devolución</small></a></td>
																<? } ?>
                                                            </tr> <? 
                                                            $tot1=$tot1+$recset["Escuelas"];	$tot2=$tot2+$recset["registradas"];	$tot3=$tot3+$recset["porregistrar"]; 	$r++; 
                                                        } ?>		 
                                                    <tr class="fdark-gray"><td colspan='3'>Total</td><td style="text-align:center"><? echo $tot1; ?></td><td style="text-align:center"><? echo $tot2; ?></td><td style="text-align:center"><? echo $tot3; ?></td><td class='fright-align'></td><td></td></tr> 
                                                </table><? 
                                            }
                                    }else{ ?>
                                        <br><br><br><br><br><div class="fcenter"><h2>No hay registros</h2></div>
                                            <? 
                                    }
                                    // --------------------
								}
...
function PieRecibo($contenido,$direnviado){
	...
	<table width="100%">
		<tr>	
				...
				<td class="text-center"><small>Fecha de devolución y/o entrega de paquetes libros</small><br><br><br><small>________________________ VER. A ______ DE___________________ DE <? echo substr($_SESSION["vg_cicloescolar"],0,4); ?></small></td></tr>
		</tr>
	</table>
	<br>
	...
	<br><br><div align="left"><span style='font-size:10px; text-align:left; font-weight:100'><? echo url_actual(); ?></span></div>
	<?php
}   

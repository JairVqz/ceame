    ...
    if ((!isset($logeado) && !isset($TxtUsuario))){
        ...
        if ($_SESSION["vg_tipousuario"]=="Almacen" && !isset($_GET["x"])){
                        ...
                        <tr><th>Sector</th><th>Zona</th><th>Cct-zona</th><th>Nombre</th><th></th></tr><? 
                            while ($r<mysql_num_rows($res)){ 		$recset=mysql_fetch_array($res,MYSQL_ASSOC); $tot=0; 
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <small><a class="fbutton fpadding-tiny fround fbold fpale-blue" href="<? echo $autollamada."x&n=".$_GET["n"]."&".$nomarreglo."=".oculta($caddatos,0); ?>">Recibo del libro de Cartografía</a></small>    
                                    </td> 
                                </tr> <? 
                                $r++; 
                            } ?>		 
            ...
            if ($_SESSION["vg_tipousuario"]=="Supervisor" && !isset($_GET["seleccionado"])){
                ...
                // -----------------------------------------------------------------------------------------------------------------------------------------------------
                $liga1="Recibo del libro de Cartografía|".$autollamada."seleccionado&||#F9FFE4|";	//Boton|liga|Columna|color|idnivel|nivelesrestringidos
            ...
            if ($vl_procede==1){ 
                ...
                <div style='margin-left:50px; margin-right:50px;  font-weight:bold'>
                            ...
                            <span style="font-weight:bold; font-size:16px">Recibo de zona del "Libro de Cartografía para alumnos de 4°,5° y 6°" (P0CMA)<br>
                ...
                //---------------------------------------------------------------------------------------------------------------------------------------------- ?>
                            ...
                            <tr><td rowspan=2></td><td style="font-size:16px; font-weight:bold;">Clave</td><td colspan=3 style="font-size:16px; font-weight:bold;">Ciclo <? echo $_SESSION["vg_cicloescolaranterior"]; ?></td><td colspan=3 style="font-size:16px; font-weight:bold;">Ciclo <? echo $_SESSION["vg_cicloescolar"]; ?></td><td colspan=3 style="font-size:16px; font-weight:bold;">&emsp;Conciliación&emsp;</td><td colspan=3 rowspan=2 style="font-size:16px; font-weight:bold;">Firma del director</td></tr>
                            ...
                            <table cellpadding="7" cellspacing="0" width="100%" border=1><tr><td>NOTA: Recibe del libro de Cartografía, la cantidad que se identifica<br>como necesidad por plantel, de acuerdo al análisis de matricula real<br> entre los ciclos escolares <? echo $_SESSION["vg_cicloescolaranterior"]." y ". $_SESSION["vg_cicloescolar"]; ?>  </td></tr></table>
                            <br><br>

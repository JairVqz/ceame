<?php session_start(); 	 require_once('../conecta2023.php'); require_once('../inc/funciones_libros.php');  conectalo("almacen"); ?>
<!doctype html>    <html lang="es">
<head>
	<meta charset="ISO-8859-1">      	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Consulta general de CT</title>
                                    ...
                                    <tr><th>Zona</th><th>Clave</th><th>Escuelas</th><th>Municipio</th><th>Localidad</th><th></th></tr><? 
                                        while ($r<mysql_num_rows($res)){ 		$recset=mysql_fetch_array($res,MYSQL_ASSOC);   ?>
                                            <tr> 
                                                ...
                                                <td align="center"><small><a href="../../ingresosupervisor/<? echo $liga; ?>arr_nivel=<?  echo $arrnivel[0]."|".$arrnivel[1]."&zona=".$recset['cct_zona'];  ?>" class="fbutton fpale-green">Ver escuelas</a></small></td>
                                            </tr> <? 
                                               $r++; 
                                        } ?>		 
